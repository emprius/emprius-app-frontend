...
//List<TransportNeeded>transport; ?
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('needsTransport', needsTransport))
      ..add(DiagnosticsProperty('maybeFree', maybeFree))
      ..add(DiagnosticsProperty('rating', rating))
      ..add(DiagnosticsProperty('cost', cost))
      ..add(DiagnosticsProperty('askWithFee', askWithFee))
      ..add(DiagnosticsProperty('estimatedValue', estimatedValue))
