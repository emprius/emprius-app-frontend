...
/// An interceptor fires automatically
/// for each request, response or error depending on which method it overrides.
///
/// This Api Interceptor class holds intercepting logic
/// for API related requests.
/// This is the first interceptor in case of both request and response.
///
