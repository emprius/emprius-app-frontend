...
class MapValidator{
  ...
  /// Should return null if no error or a error message string if error.
  /// It passes selected position when onTap
  ...
  /// Error message to show when validate function fails
  String? _errorMsg;
